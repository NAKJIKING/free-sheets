...
COMPOSER_TAGS = {
    ...
    'Carl Czerny': '체르니 车尔尼',
    # ── 입문 교재 작곡가 보강 (2026-09-05) ─────────────────────────
    # 악기별 입문 교재(바이올린·첼로·기타·관악)의 표준 저자들 — 교본 89권과
    # 개별곡 500곡이 한국어로 안 잡히던 것. 표기 변형마다 등록한다.
    'Franz Wohlfahrt': '볼파르트 볼파르 沃尔法特',
    'Heinrich Ernst Kayser': '카이저 카이제르 凯泽',
    'Kayser': '카이저 카이제르 凯泽',
    'Charles Dancla': '당클라 단클라 丹克拉',
    'Jakob Dont': '동트 돈트 东特',
    'Jacques Féréol Mazas': '마자스 马扎斯',
    'F. Mazas': '마자스 马扎斯',
    'Mazas Duet': '마자스 马扎斯',
    'Charles-Auguste de Bériot': '베리오 베리오트 贝里奥',
    'Delphin Alard': '알라르 알라르드 阿拉尔',
    'Friedrich August Kummer': '쿠머 库默尔',
    'Justus Johann Friedrich Dotzauer': '도츠아우어 도차우어 多茨奥尔',
    'Carl Baermann': '베르만 베어만 贝尔曼',
    'Benoît Tranquille Berbiguier': '베르비귀에 贝尔比吉耶',
    'Berbiguier': '베르비귀에 贝尔比吉耶',
    'Jean-Louis Tulou': '튈루 툴루 蒂卢',
    'Jean-Baptiste Arban': '아르방 아르반 阿尔班',
    'Joseph Jean Baptiste Laurent Arban': '아르방 아르반 阿尔班',
    'Ernesto Cavallini': '카발리니 卡瓦利尼',
    'Carl Reinecke': '라이네케 莱内克',
    'Dionisio Aguado': '아과도 아구아도 阿瓜多',
    'D. D. Aguado': '아과도 아구아도 阿瓜多',
    'Dinioso Aguado': '아과도 아구아도 阿瓜多',
    'Luigi Legnani': '레냐니 레그나니 莱尼亚尼',
    'Johann Kaspar Mertz': '메르츠 梅尔茨',
    'J.k. Mertz': '메르츠 梅尔茨',
    'Napoléon Coste': '코스트 科斯特',
    'Napoleon Coste': '코스트 科斯特',
    'N. Coste': '코스트 科斯特',
    'Albert Loeschhorn': '뢰슈호른 뢰쉬호른 勒施霍恩',
    'Theodor Kullak': '쿨라크 쿨라 库拉克',
    'Johann Baptist Cramer': '크라머 크라메르 克拉默',
    # 한국 피아노 입문의 표준 교재인데 검색어가 없어 한국어로는 한 건도
    # 안 잡히던 것들. 카탈로그에 표기 변형이 섞여 있어(정규화가 합치지
    # 않는다) 변형마다 등록한다.
    'Ferdinand Beyer': '바이엘 바이어 拜厄',
    'Theodor Oesten': '오이스텐 외스텐 厄斯滕',
    'Henri Bertini': '베르티니 贝尔蒂尼',
    'H. Bertini': '베르티니 贝尔蒂尼',
    'Franz Wohlfahrt': '볼파르트 볼파르 沃尔法特',
    'Wohlfahrt': '볼파르트 볼파르 沃尔法特',
    'Johann Friedrich Franz Burgmüller': '부르크뮐러 부르그뮐러 布格缪勒',
    'Johann Friedrich Burgmuller': '부르크뮐러 부르그뮐러 布格缪勒',
    'J.f.f. Burgmuller': '부르크뮐러 부르그뮐러 布格缪勒',
    'Freidrich Burgmüller': '부르크뮐러 부르그뮐러 布格缪勒',
    'A. Diabelli': '디아벨리 迪亚贝利',
    'Anton Diabelli': '디아벨리 迪亚贝利',
    'Ernesto Köhler': '쾰러 켈러 科勒',
    'Louis Köhler': '쾰러 켈러 科勒',
    'E. Kohler': '쾰러 켈러 科勒',
    'Daniel Gottlob Türk': '튀르크 튜르크 图尔克',
    'F. Kuhlau': '쿨라우 库劳',
    'Hermann Berens': '베렌스 贝伦斯',
    'L. Streabbog': '스트레아보그 斯特里博格',
    'Fritz Spindler': '스핀들러 施平德勒',
    'Franz Behr': '베어 贝尔',
    'Alexander Reinagle': '레이너글 雷纳格尔',
    'Henry Lemoine': '르무안 勒穆瓦纳',
    'H.Lemoine': '르무안 勒穆瓦纳',
    'C. L. Hanon': '하농 하논 哈农',
    'Jean-Baptiste Duvernoy': '뒤베르누아 迪韦尔努瓦',
    'Jean-Baptiste Duvernoy c. 1802 c': '뒤베르누아 迪韦尔努瓦',
    'Charles-Louis Hanon': '하농 하논 哈农',
